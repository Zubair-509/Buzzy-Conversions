...
const toolsData = {
  ...
  'jpg-to-png': {
    ...
    steps: [
      { id: 'upload', label: 'Upload', description: 'Uploading your file to our secure servers...' },
      { id: 'converting', label: 'Converting', description: 'Converting your JPG to PNG format...' },
      { id: 'optimizing', label: 'Optimizing', description: 'Optimizing image quality...' },
      { id: 'complete', label: 'Complete', description: 'Your file is ready to download!' },
    ],
  },
  'merge-pdf': {
    ...
    outputFormat: '.pdf',
    steps: [
      { id: 'upload', label: 'Upload', description: 'Uploading your files to our secure servers...' },
      ...
      { id: 'complete', label: 'Complete', description: 'Your merged file is ready to download!' },
    ],
  },
